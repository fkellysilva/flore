(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__a33d15._.js", {
...
"[project]/src/app/i18n/settings.js [middleware] (ecmascript)": (function(__turbopack_context__) {

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: require } = __turbopack_context__;
{
const e = new Error("Could not parse module '[project]/src/app/i18n/settings.js'");
...
(()=>{
    const e = new Error("Cannot find module './src/app/i18n/settings'");
...
;
;
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$accept$2d$language$2f$Build$2f$Source$2f$AcceptLanguage$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"].languages(languages);
const config = {
    // matcher: '/:lng*'
    matcher: [
...
function middleware(req) {
    let lng;
    if (req.cookies.has(cookieName)) lng = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$accept$2d$language$2f$Build$2f$Source$2f$AcceptLanguage$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"].get(req.cookies.get(cookieName).value);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a33d15._.js.map